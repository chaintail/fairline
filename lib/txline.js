...
// Cup Final feed (fixture 18257739) across the actual match: 1 = not
// started, 2 = first half, 3 = half-time break, 4 = second half (confirmed
// directly at the real second-half kickoff event, Clock.Seconds resuming
// at 2700 = 45:00). Code 6 was observed at the real end of regulation
// (Clock.Seconds stopped at exactly 5400 = 90:00) — evidently some
// post-regulation sub-phase (this fixture finished 0-0, so extra time),
// but the exact ET/HTET/ET2/penalties numbering isn't individually
// confirmed. Rather than guess at unobserved codes, any numeric code past
// 4 is treated as "END" here: a slightly-imprecise "full time" label is
// far less wrong than falling back to the GameState string (which reads
// as pre-match) — matches the existing "regulation only" limitation
// documented above.

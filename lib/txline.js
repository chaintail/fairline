...
// and 6300 respectively — identical pattern to the H1/H2 kickoffs). Code 5
// and 8 (an HTET break presumably sits there, mirroring 3/6's pattern, but
// wasn't directly observed — it may have rolled out of a windowed poll)
// and anything past 9 (awaiting pens/penalties/final full time) are not
// individually confirmed — any other numeric code is treated as "END":
// imprecise, but far less wrong than falling back to the GameState string
// (which reads as pre-match). Matches the existing "regulation only"
// limitation documented above for whatever remains unconfirmed.

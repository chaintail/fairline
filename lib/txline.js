...
//  - scores: { FixtureId, GameState, StatusSoccerId/statusSoccerId, Clock,
...
export function scoreToState(payload) {
  ...
  const status = g(payload, "StatusSoccerId", "statusSoccerId");
  const phase = typeof status === "string" ? status : g(payload, "GameState", "gameState");

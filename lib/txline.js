...
// half (confirmed directly at the real ET kickoff event: Action "kickoff",
// Clock resuming at 5400, identical pattern to the H1/H2 kickoffs). Code 5
// and anything past 7 (HTET/ET2/awaiting pens/penalties/final full time)
// are not individually confirmed — any other numeric code is treated as
// "END": imprecise, but far less wrong than falling back to the GameState
// string (which reads as pre-match). Matches the existing "regulation
// only" limitation documented above for whatever remains unconfirmed.
